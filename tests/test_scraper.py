...
class TestFetchRegion:
    ...
    async def test_successful_fetch(self):
        ...
        mock_response.json.return_value = {'data': {'markers': [{'token': 'm1'}, {'token': 'm2'}]}}
...
class TestFetchItemDetail:
    ...
    async def test_parking_zero_is_false(self):
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': {'additional_info_items_v2': [], 'parking': '0', 'balconies': '0'}}
    ...
    async def test_parking_non_digit_is_false(self):
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {'data': {'additional_info_items_v2': [], 'parking': 'none'}}
