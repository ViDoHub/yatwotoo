    ...
    return {
        'data': {
            'additional_info_items_v2': [
                ...
                {'key': 'renovated', 'value': True},
                {'key': 'long_term', 'value': False},
            ...
            'info_bar_items': [
                {'key': 'rooms', 'title': '4 חדרים', 'titleWithoutLabel': '4'},
                {'key': 'entrance', 'title': '04/04/2026', 'titleWithoutLabel': '04/04/2026'},
            ],
            'date_added': '2026-04-04 00:03:39',
            'date_raw': '2026-04-04 00:08:30',
            'property_tax': '1,100 ₪',
            'HouseCommittee': '300 ₪',
            'TotalFloor_text': 7,
            'contact_name': 'יוסף',
